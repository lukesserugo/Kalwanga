  ...
  return (
    <div className="text-center py-8">
      ...
      {actionLabel && onAction && (
        <button
          onClick={onAction}
          className="mt-3 px-3 py-1.5 text-sm bg-brand-gradient text-white rounded-lg shadow-brand hover:shadow-brand-lg transition-all focus-ring"
        >
          {actionLabel}
        </button>
      )}
...
export function InventorySettings() {
  ...
  const handleSave = async () => {
    ...
    if (settings.enableStockNotifications && settings.notificationEmail) {
      ...
      if (!emailRegex.test(settings.notificationEmail)) {
        setErrors({
          ...errors,
          notificationEmail: 'Please enter a valid email address',
        });
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
          You need to be logged in to manage inventory settings
        </p>
      </div>
    );
  }
  ...
  if (!canManage) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
          You don't have permission to manage inventory settings
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-6 animate-fade-in">
      {error && (
        <div className="p-4 bg-danger-50 dark:bg-danger-900/20 border border-danger-200 dark:border-danger-800 rounded-2xl flex items-start gap-3 animate-slide-down">
          ...
          <button
            ...
            className="p-1 hover:bg-danger-100 dark:hover:bg-danger-800/30 rounded transition focus-ring"
          >
      ...
      {success && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="p-4 bg-success-50 dark:bg-success-900/20 border border-success-200 dark:border-success-800 rounded-2xl flex items-center gap-3"
        >
      ...
      <div className="card-brand">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="px-4 py-2 bg-brand-gradient text-white rounded-lg shadow-brand hover:shadow-brand-lg flex items-center gap-2 transition-all disabled:opacity-50 focus-ring"
          >
            {saving ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  defaultReorderQuantity: parseInt(e.target.value) || 0,
                })
              }
              className="input-brand tabular-nums"
              min="0"
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setSettings({ ...settings, defaultSupplier: e.target.value })
              }
              className="input-brand"
              disabled={saving}
            >
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-3 py-1.5 text-sm bg-brand-gradient text-white rounded-lg shadow-brand hover:shadow-brand-lg flex items-center gap-1 transition-all focus-ring"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {settings.categories.map((category) => (
              <motion.div
                ...
                className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/30 rounded-lg border border-gray-200 dark:border-gray-600 hover:border-brand-300 transition-colors"
              >
                ...
                <div className="flex gap-1 flex-shrink-0 ml-2">
                  <button
                    ...
                    className="p-1.5 hover:bg-orange-50 dark:hover:bg-gray-600 rounded transition-colors focus-ring"
                  >
            ...
            {settings.locations.map((location) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  {location.type && (
                    <span className="text-2xs px-1.5 py-0.5 bg-gray-200 dark:bg-gray-600 rounded-full text-gray-600 dark:text-gray-300">
            ...
            {settings.suppliers.map((supplier) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-2 mt-0.5 text-2xs text-gray-400 tabular-nums">
                    {supplier.phone && (
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  lowStockAlertThreshold: parseInt(e.target.value) || 0,
                })
              }
              className="input-brand tabular-nums"
              min="0"
            ...
            <p className="text-2xs text-gray-400 dark:text-gray-500 mt-1">
              ...
              (e.g., 20% = alert at 80% of reorder point)
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  enableAutoReorder: e.target.checked,
                })
              }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setSettings({
                    ...settings,
                    autoReorderDays: parseInt(e.target.value) || 0,
                  })
                }
                className="input-brand tabular-nums"
                min="1"
              ...
              />
              <p className="text-2xs text-gray-400 dark:text-gray-500 mt-1">
                Check stock levels every X days
              </p>
            </div>
          )}
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  enableStockNotifications: e.target.checked,
                })
              }
              className="w-4 h-4 text-brand-600 rounded border-gray-300 focus:ring-brand-500 focus:outline-none"
              disabled={saving}
      ...
      <SettingSection
        ...
        icon={Shield}
        description="Advanced inventory configuration"
      >
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  enableBarcodeScanning: e.target.checked,
                })
              }
              className="w-4 h-4 text-brand-600 rounded border-gray-300 focus:ring-brand-500 focus:outline-none"
              disabled={saving}
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  enableQrGeneration: e.target.checked,
                })
              }
              className="w-4 h-4 text-brand-600 rounded border-gray-300 focus:ring-brand-500 focus:outline-none"
              disabled={saving}
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        <div className="text-2xs text-gray-400 dark:text-gray-500 tabular-nums">
          Last saved: {new Date().toLocaleString()}
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
          className="px-6 py-2.5 bg-brand-gradient text-white rounded-lg shadow-brand hover:shadow-brand-lg flex items-center gap-2 transition-all disabled:opacity-50 focus-ring"
        >
          {saving ? (
            <Loader2 className="w-4 h-4 animate-spin" />
          ) : (
