// D:\Projects\Kalwanga\packages\web\components\checkout\CheckoutSuccessToast.tsx
...
import { formatCurrency } from '../../utils/formatters'; // ✅ ADD THIS
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Order #{receiptNumber} - {formatCurrency(total)} {/* ✅ FIXED */}
                </p>
                <div className="mt-3 flex gap-2">
                  ...
                  <button
                    onClick={onClose}
                    className="text-sm px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-gray-700 dark:text-gray-300"
                  >
                    Dismiss
                  </button>
                </div>
