...
import {
  ...
  Loader2, AlertCircle, Gift,
  CreditCard, Banknote, Wallet, Building, Star,
...
function normalizeOrder(raw: any): Order {
  ...
  return {
    id: raw.id,
    orderNumber: raw.orderNumber || raw.receiptNumber || raw.id?.slice(0, 8) || 'N/A',
...
export default function OrderConfirmationPage() {
  ...
  const loadOrder = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        console.warn('Order lookup by ID failed, trying by number:', err?.message);
        try {
  ...
  const handlePrint = () => {
    // Route to the dedicated print page which renders a print-optimized view
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 mt-20">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    {item.variantName && (
                      <span className="ml-2 text-xs">({item.variantName})</span>
                    )}
                  </p>
                </div>
        ...
        >
          <button
            ...
            className="flex-1 min-w-[180px] px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors flex items-center justify-center gap-2"
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-600 dark:text-blue-400">
                  ...
                  {formatCurrency(Math.floor(order.total / 10) * 0.1)} discount on
                  your next order
                </p>
              </div>
            </div>
