...
export default function PaymentPage() {
  ...
  const handlePaymentComplete = async (payment: any) => {
    ...
    window.dispatchEvent(
      new CustomEvent('payment:completed', { detail: payment }),
    );
      ...
      >
        <div className="max-w-2xl mx-auto px-4 pt-24 md:pt-28 pb-12">
          ...
          >
            ...
            <Link
              href="/shop"
              className="mt-6 inline-flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-lg transition-colors shadow-md"
            >
            ...
            <div key={s.step} className="flex items-center">
              <div
                className={`flex items-center gap-2 px-3 py-2 rounded-lg transition ${
                  step === 'select' && s.step === 1
                    ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300'
                    : step === 'pay' && s.step === 2
                      ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300'
                      : step === 'complete' && s.step === 3
                      ...
                      <div className="relative w-10 h-10 flex-shrink-0">
                        {getProviderImageUrl(selectedProvider) ? (
                          ...
                          <span className="text-2xl">
                            {getProviderConfig(selectedProvider).icon}
                          </span>
                        )}
                      </div>
                      <div>
                ...
                <div>
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        {getProviderImageUrl(paymentResult.provider) ? (
                          <Image
                            ...
                            alt={
                              getProviderConfig(paymentResult.provider)
                                .name
                            }
                            width={20}
                            height={20}
                        ...
                        >
                          via{' '}
                          {getProviderConfig(paymentResult.provider).name}
                        </span>
                      </div>
                    )}
                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    <button
                      ...
                      className="flex-1 px-6 py-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-lg transition-colors flex items-center justify-center gap-2 shadow-md"
                    >
                      <ShoppingBag className="w-4 h-4" />
                      Continue Shopping
                    </button>
