    ...
    <div className="space-y-6 p-4 sm:p-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 w-full sm:w-auto">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-2 flex-wrap">
              <Settings className="w-6 h-6 sm:w-7 sm:h-7 text-brand-500 flex-shrink-0" />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
        ...
        <StatsCard
          ...
          value="Enabled"
          icon={<Lock className="w-5 h-5" />}
          bgColor="bg-danger-100 text-danger-600 dark:bg-danger-900/30 dark:text-danger-400"
        />
        <StatsCard
          title="Audit Logging"
                ...
                <div key={change.id} className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 truncate">
                      From: <span className="text-danger-600 font-mono">{change.oldValue}</span> → To: <span className="text-success-600 font-mono">{change.newValue}</span>
                    </p>
          ...
          return (
            <div
              ...
              className={`bg-white dark:bg-gray-800 rounded-xl shadow-sm border transition-all overflow-hidden ${
                isActive ? 'border-brand-500 dark:border-brand-400' : 'border-gray-200 dark:border-gray-700'
              }`}
            >
              {/* Section Header */}
              <div
              ...
              >
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  {section.badge !== undefined && section.badge > 0 && (
                    <span className="px-2 py-0.5 bg-brand-100 dark:bg-brand-900/30 text-brand-700 dark:text-brand-400 rounded-full text-xs font-medium tabular-nums">
                      {section.badge}
                    </span>
                  )}
                  <button
                    ...
                    className={`p-1.5 rounded-lg transition-colors focus-ring ${
                      isActive ? 'bg-brand-100 dark:bg-brand-900/30 text-brand-600' : 'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-400'
                    }`}
                  >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            Default Role <span className="text-danger-500">*</span>
                          </label>
                          <select
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            min={6}
                            max={32}
                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent tabular-nums"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        ...
                        {settings.allowedIPAddresses.length > 0 && (
                          <div className="flex flex-wrap gap-2">
                            {settings.allowedIPAddresses.map(ip => (
                              <span key={ip} className="inline-flex items-center gap-1 px-2 py-1 bg-brand-50 dark:bg-brand-900/20 text-brand-700 dark:text-brand-300 rounded-lg text-xs">
                                {ip}
                                <button onClick={() => handleRemoveIPAddress('allowed', ip)} className="text-brand-500 hover:text-brand-700 focus-ring rounded">
                                  <X className="w-3 h-3" />
                                </button>
                              </span>
                            ))}
                      ...
                      <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 mb-2">
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-danger-600 text-white rounded-lg hover:bg-danger-700 transition-colors text-sm focus-ring"
                          >
                            Block
                          </button>
                        </div>
                        {settings.blockedIPAddresses.length > 0 && (
                          <div className="flex flex-wrap gap-2">
                            {settings.blockedIPAddresses.map(ip => (
                              <span key={ip} className="inline-flex items-center gap-1 px-2 py-1 bg-danger-50 dark:bg-danger-900/20 text-danger-700 dark:text-danger-300 rounded-lg text-xs">
                                {ip}
                                <button onClick={() => handleRemoveIPAddress('blocked', ip)} className="text-danger-500 hover:text-danger-700 focus-ring rounded">
                                  <X className="w-3 h-3" />
                                </button>
                              </span>
                            ))}
                        ...
                        {settings.allowedDomains.length > 0 && (
                          <div className="flex flex-wrap gap-2">
                            {settings.allowedDomains.map(domain => (
                              <span key={domain} className="inline-flex items-center gap-1 px-2 py-1 bg-brand-50 dark:bg-brand-900/20 text-brand-700 dark:text-brand-300 rounded-lg text-xs">
                                {domain}
                                <button onClick={() => handleRemoveDomain('allowed', domain)} className="text-brand-500 hover:text-brand-700 focus-ring rounded">
                                  <X className="w-3 h-3" />
                                </button>
                              </span>
                            ))}
                        ...
                        {settings.blockedDomains.length > 0 && (
                          <div className="flex flex-wrap gap-2">
                            {settings.blockedDomains.map(domain => (
                              <span key={domain} className="inline-flex items-center gap-1 px-2 py-1 bg-danger-50 dark:bg-danger-900/20 text-danger-700 dark:text-danger-300 rounded-lg text-xs">
                                {domain}
                                <button onClick={() => handleRemoveDomain('blocked', domain)} className="text-danger-500 hover:text-danger-700 focus-ring rounded">
                                  <X className="w-3 h-3" />
                                </button>
                              </span>
                            ))}
              ...
              <div className="text-center">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm focus-ring"
                  >
                    Reset to Saved Values
                  </button>
                  <button
                    onClick={handleResetToDefaults}
                    className="w-full px-4 py-2 bg-warning-600 text-white rounded-lg hover:bg-warning-700 transition-colors text-sm focus-ring"
                  >
                    Reset to Defaults
                  </button>
                  <button
