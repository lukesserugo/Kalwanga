...
import { Save, X, Building, MapPin, Phone, Mail, Globe, Loader2, DollarSign, Clock, Briefcase } from 'lucide-react';
    ...
    try {
      ...
      if (isEdit && id) {
        ...
        const companyPayload = {
          ...payload,
          // Add business unit info for creation
        ...
        if (result?.id) {
          ...
          // If business unit was created, store its ID too
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              {isEdit ? 'Update company information' : 'Add a new company to your organization'}
            </p>
          </div>
          <button
            type="button"
          ...
          {!isEdit && (
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white">Default Business Unit</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="businessUnitName" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 bg-white dark:bg-gray-900 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 ${
                      errors.businessUnitName ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                    }`}
                  ...
                  {errors.businessUnitName && (
                    <p className="mt-1 text-sm text-red-500">{errors.businessUnitName}</p>
                  )}
                </div>

                <div>
                  <label htmlFor="businessUnitCode" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 bg-white dark:bg-gray-900 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 uppercase ${
                      errors.businessUnitCode ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                    }`}
                    placeholder="MAIN"
                    required
                    disabled={saving}
                  ...
                  {errors.businessUnitCode && (
                    <p className="mt-1 text-sm text-red-500">{errors.businessUnitCode}</p>
                  )}
                </div>

                <div>
                  <label htmlFor="businessUnitType" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Business Unit Type
                  </label>
                  <select
                    id="businessUnitType"
