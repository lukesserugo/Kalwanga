          ...
          <div className="card-brand shadow-soft">
            <div className="flex items-center justify-between">
              ...
              <div className={`p-3 rounded-lg ${isDark ? 'bg-primary-900/20' : 'bg-primary-100'}`}>
                <DollarSign className={`w-6 h-6 ${isDark ? 'text-primary-400' : 'text-primary-600'}`} />
              </div>
            </div>
          </div>
          <div className="card-brand shadow-soft">
            <div className="flex items-center justify-between">
              ...
              <div className={`p-3 rounded-lg ${isDark ? 'bg-success-900/20' : 'bg-success-100'}`}>
                ...
                <table className="w-full">
                  ...
                  <tbody className={`divide-y ${isDark ? 'divide-gray-700' : 'divide-gray-200'}`}>
                    {refunds.map((refund) => {
                      ...
                      return (
                        <tr key={refund.id} className={`transition-colors duration-250 ${
                          ...
                          <td className="px-4 py-3 text-right">
                            <p className={`text-sm font-bold tabular-nums text-danger-600 dark:text-danger-400`}>
                              -{formatCurrency(refund.amount)}
                            </p>
                          </td>
                          <td className="px-4 py-3">
                            <span className={`px-2 py-1 text-2xs font-medium rounded-full flex items-center gap-1 w-fit ${getStatusColor(refund.status)}`}>
            ...
            <div className={`max-w-2xl w-full max-h-[90vh] overflow-y-auto rounded-2xl shadow-xl ${
              ...
              <div className={`sticky top-0 z-10 p-4 border-b ${
                ...
                <div>
                  ...
                  <p className={`text-sm font-mono tabular-nums ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className={`p-4 rounded-xl ${isDark ? 'bg-gray-700/30' : 'bg-gray-50'}`}>
                    ...
                    <p className={`text-2xl font-bold tabular-nums text-danger-600 dark:text-danger-400`}>
