...
export default function EditCustomerPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border p-6 space-y-6">
        ...
        <div className="flex justify-end gap-3 pt-4 border-t">
          <Link href="/admin/customers" className="px-4 py-2 border border-gray-300 rounded-lg">
            Cancel
          </Link>
          <button
            type="submit"
